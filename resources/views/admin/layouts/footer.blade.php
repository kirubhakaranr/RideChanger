   ...
   <div class="customizer d-none d-md-block">
    ...
    <div class="customizer-content">
        ...
        <div class="customizer-header px-2 pt-1 pb-0 position-relative">
            <h4 class="mb-0">Style Customizer</h4>
 ...
 <!-- BEGIN: Footer-->
        <footer class="footer footer-static footer-light">
            <p class="clearfix mb-0">
                <span class="float-md-left d-block d-md-inline-block mt-25">&copy; 2021<a class="ml-25" href="#" target="_blank">Invest In Shares</a><span class="d-none d-sm-inline-block">, All rights Reserved</span></span>
                <span class="float-md-right d-none d-md-block">Developed by <a class="ml-25" href="https://www.codetez.com" target="_blank">CodeTez</a></span>
            </p>
        </footer>
